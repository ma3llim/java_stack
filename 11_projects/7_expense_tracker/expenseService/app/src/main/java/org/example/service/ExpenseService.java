...
public class ExpenseService {
    ...
    public boolean updateExpense(ExpenseDto expenseDto) {
        ...
        expense.setMerchant(StringUtils.isNotBlank(expenseDto.getMerchant()) ? expenseDto.getMerchant() : expense.getMerchant());
        expense.setCurrency(StringUtils.isNotBlank(expenseDto.getCurrency()) ? expenseDto.getMerchant() : expense.getCurrency());
